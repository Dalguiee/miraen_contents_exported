...
//   console.log(iText);
//   // const uText = iText.replace("(", `<span class="suit">(</span>`).replace(")", `<span class="suit">)</span>`);
//   // item.innerHTML = uText;
...
//   // iText = iText.replace(/\(\s*/g, `<span class="suit">(</span>`);
//   // iText = iText.replace(/\s*\)/g, `<span class="suit">)</span>`);
//   // iText = iText.replace(/\‘\s*/g, `<span class="notoSans">‘</span>`);
//   // iText = iText.replace(/\’\s*/g, `<span class="notoSans">’</span>`);
//   // iText = iText.replace(/\,\s*/g, `<span class="notoSans">,</span>`);
//   // iText = iText.replace(/\,\s*/g, `<span class="notoSans">,</span>`);
